<template>
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="newProductTable" :data="personVerifiedData" style="width: 100%;" border>
      ...
      <el-dialog title="个人项目详细信息" :visible.sync="dialogFormVisible">
        <el-form :model="form">
          <el-container>
...
<script>
  ...
  import {getPersonVerified, applyUpdate, deny, applyDel, getAppealById} from '../../service/api'
  ...
  export default {
    ...
    methods: {
      getPersonVerifiedPage() {
        getPersonVerified(this.query).then(re => {
          this.personVerifiedData = re.list
          this.total = re.total
        })
      },
