<template>
  <div>
    ...
    <el-row style="float: right;margin-top: 30px;">
      <el-button type="primary" @click="handleApprove(personhelp.id)">通 过</el-button>
      <el-button type="danger" @click="handleDeny(personhelp.id)">拒 绝</el-button>
    </el-row>
  </div>
</template>

<script>
  import { getPersonDetailById, approve, deny } from '../../service/api'
  export default {
    name: "adminperson",
    data () {
      return {
