<template>
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="newProductTable" :data="publicVerifiedData" style="width: 100%;" border>
...
<script>
  ...
  import {getPublicVerified, applyUpdate, deny, applyDel, getAppealById} from '../../service/api'
  import {timeFormat} from '../../utils/util';

  export default {
    name: 'publicverified_layout',
    ...
    methods: {
      getPublicVerifiedPage() {
        getPublicVerified(this.query).then(re => {
          this.publicVerifiedData = re.list
          this.total = re.total
        })
      },
