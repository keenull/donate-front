  ...
  <div class="login-wrap">
    <el-form label-position="left" :model="ruleForm" :rules="rules" ref="ruleForm" label-width="0px" class="demo-ruleForm login-container">
      ...
      <el-form-item prop="username">
        <el-input type="text" v-model="ruleForm.username" placeholder="账号" @keyup.enter.native="submitForm('ruleForm')"></el-input>
      </el-form-item>
      ...
      <div class="later" @click="later">稍后再说</div>
    </el-form>
  </div>
</template>
<script type="text/ecmascript-6">
import { login, getCurrentUser } from '../service/api'
  ...
  methods: {
    submitForm (formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          this.logining = true
          login(this.ruleForm).then(re => {
            this.logining = false
            // setCookie('token', re.token, 7)
            this.$store.commit('login', re)
